...
public class App_변경12 {
  ...
  public static void main(String[] args) {
    ...
    int[] iNo = new int[INPUT_LENGTH];
    String[] iContent = new String[INPUT_LENGTH];
    Date[] iDeadline = new Date[INPUT_LENGTH];
    String[] iOwner = new String[INPUT_LENGTH];
    int[] iStatus = new int[INPUT_LENGTH];
    ...
    while (true) {
      ...
      if (input.equals("exit") || input.equals("quit")) {
        ...
        System.out.print("번호? ");
        iNo[iSize] = Integer.parseInt(keyboardScan.nextLine());

        System.out.print("내용? ");
        iContent[iSize] = keyboardScan.nextLine();

        System.out.print("마감일? ");
        iDeadline[iSize] = Date.valueOf(keyboardScan.nextLine());
        ...
        System.out.print("> ");
        iStatus[iSize] = Integer.valueOf(keyboardScan.nextLine());

        System.out.print("담당자? ");
        iOwner[iSize] = keyboardScan.nextLine();
