package com.eomcs.o17_a_b_c.pms;

import static com.eomcs.o17_a_b_c.menu.Menu.ACCESS_ADMIN;
import static com.eomcs.o17_a_b_c.menu.Menu.ACCESS_GENERAL;
import static com.eomcs.o17_a_b_c.menu.Menu.ACCESS_LOGOUT;
...
import com.eomcs.o17_a_b_c.menu.MenuGroup;
...
import com.eomcs.o17_a_b_c.pms.handler.AuthLoginHandler;
import com.eomcs.o17_a_b_c.pms.handler.AuthLogoutHandler;
import com.eomcs.o17_a_b_c.pms.handler.AuthUserInfoHandler;
import com.eomcs.o17_a_b_c.pms.handler.BoardAddHandler;
import com.eomcs.o17_a_b_c.pms.handler.BoardDeleteHandler;
import com.eomcs.o17_a_b_c.pms.handler.BoardDetailHandler;
import com.eomcs.o17_a_b_c.pms.handler.BoardListHandler;
import com.eomcs.o17_a_b_c.pms.handler.BoardSearchHandler;
import com.eomcs.o17_a_b_c.pms.handler.BoardUpdateHandler;
import com.eomcs.o17_a_b_c.pms.handler.Command;
import com.eomcs.o17_a_b_c.pms.handler.CommandRequest;
import com.eomcs.o17_a_b_c.pms.handler.MemberAddHandler;
import com.eomcs.o17_a_b_c.pms.handler.MemberDeleteHandler;
import com.eomcs.o17_a_b_c.pms.handler.MemberDetailHandler;
import com.eomcs.o17_a_b_c.pms.handler.MemberListHandler;
import com.eomcs.o17_a_b_c.pms.handler.MemberPrompt;
import com.eomcs.o17_a_b_c.pms.handler.MemberUpdateHandler;
import com.eomcs.o17_a_b_c.pms.handler.ProjectAddHandler;
import com.eomcs.o17_a_b_c.pms.handler.ProjectDeleteHandler;
import com.eomcs.o17_a_b_c.pms.handler.ProjectDetailHandler;
import com.eomcs.o17_a_b_c.pms.handler.ProjectListHandler;
import com.eomcs.o17_a_b_c.pms.handler.ProjectPrompt;
import com.eomcs.o17_a_b_c.pms.handler.ProjectUpdateHandler;
import com.eomcs.o17_a_b_c.pms.handler.TaskAddHandler;
import com.eomcs.o17_a_b_c.pms.handler.TaskDeleteHandler;
import com.eomcs.o17_a_b_c.pms.handler.TaskDetailHandler;
import com.eomcs.o17_a_b_c.pms.handler.TaskListHandler;
import com.eomcs.o17_a_b_c.pms.handler.TaskUpdateHandler;
...
public class App {
  ...
  public App() {
    ...
    commandMap.put("/board/detail", 
        new BoardDetailHandler(boardList));
