...
public class App5 {
  ...
  static String input; //사용자가 입력한 값을 보관하는 변수, 서로 공유하기로 한 값
...
static void listMember() {
  ...
  static void addProject() {
    ...
    System.out.print("번호? "); //로컬변수로 설정되어서 접금할수없음 ->프로젝트변수를 클래스변수로 바꾸자!
  ...
  static void listProjects () {
    ...
    static void prompt() {
      System.out.print("명령> ");  //사용자가 무언갈 저장하고 input에 저장하는 문구 , 근데 input은 main이 사용함
      input = keyboardScan.nextLine();  //String 삭제 왜? 로컬변수에 저장하면 안되고 main 메서드와 공유하기로 했으니깐 지워줘야 함, 위로 따로 뺌
    }
  }
}
