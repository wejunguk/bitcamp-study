package com.eomcs.o6_a.pms;

import com.eomcs.o6_a.pms.hadler.BoardHandler;
import com.eomcs.o6_a.pms.hadler.MemberHandler;
import com.eomcs.o6_a.pms.hadler.ProjectHandler;
import com.eomcs.o6_a.pms.hadler.TaskHandler;
import com.eomcs.o6_a.util.Prompt;
...
public class App {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      }  else if (input.equals("/task/datail")) {
        taskHandler.datail();
