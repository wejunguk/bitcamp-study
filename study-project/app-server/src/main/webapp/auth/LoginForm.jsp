...
<div class="mb-3 row">
  <div class="col-sm-10">
    <div class="form-check">
	    <input id='f-saveEamil' class='form-check-input' type='checkbox' name="saveEmail"
	    vlaue="form-control" ${not empty cookie.email ? "ckecked":""}>
		  <label for='f-saveEamil' class="col-sm-2 col-form-label">이메일 저장</label>
    </div>
  </div>
</div>
