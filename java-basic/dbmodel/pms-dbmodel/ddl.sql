...
CREATE TABLE pms_project (
  ...
  title      VARCHAR(255)       NOT NULL COMMENT '제목', -- 제목
  content    <데이터 타입 없음> NOT NULL COMMENT '내용', -- 내용
...
CREATE TABLE pms_task (
  ...
  member_no      INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  project_no     INTEGER NOT NULL COMMENT '프로젝트번호', -- 프로젝트번호
  task_status_no INTEGER NULL     COMMENT '작업상태번호', -- 작업상태번호
  content        TEXT    NOT NULL COMMENT '내용', -- 내용
...
CREATE TABLE pms_comment (
  cpmment_no INTEGER            NOT NULL COMMENT '댓글번호', -- 댓글번호
  content    <데이터 타입 없음> NOT NULL COMMENT '내용', -- 내용
...
ALTER TABLE pms_comment
  MODIFY COLUMN cpmment_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '댓글번호';
