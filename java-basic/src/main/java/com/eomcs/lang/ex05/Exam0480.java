...
public class Exam0480 {
  public static void main(String[] args) {
    ...
    // 해설 : 어떤 값에 대해 GENERAL 값을 & 한다는 것은
    // LOGOUT 비트(오른쪽에서 두 번째 비트)가 1인지 검사한다는 뜻이다.
    System.out.println((menu1 & GENERAL) > 0);
    // 계산 원리
    // menu1 :  00000001
    // GENERAL : 0000100
    //        --------------
    //             00000000    <----- 0 보다 큰 값이 나온다.
    // 해설 : 어떤 값에 대해 ADMIN 값을 & 했을 대 true가 나온다면,
    // 그 값을 2진수로 보았을 대 ADMIN 비트가 1이라는 의미다.
  }
}
