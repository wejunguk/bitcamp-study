...
public class Exam0220 {
  public static void main(String[] args) {
    ...
    // 987.6543 + 1.111111 = 988.7654110000001 -> 쓰레기가 붙는다 . 결론은 
    // => 결과 뒤에 극소수의 값이 붙는다.
    ...
    // d1 + d2와 달리 x + y의 계산 결과는 뒤에 극소수의 값이 붙지 않는다. 딱 맞아 떨어진거지. 
    ...
    double EPSILON = 0.00001; // 개발자가 정함, epsilon 극한의 작은값, 비교값과 비교값을 빼고
    //극한의 작은값보다 작으면 두수가 같다고 그냥 치자~ 이렇게 처리함
